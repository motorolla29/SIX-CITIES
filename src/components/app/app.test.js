...
const OFFER = {
  ...
  descriptions: [
    "Nice, cozy, warm big bed house",
    "This building is green and from 18th century.",
  ],
  photos: {
    main: "https://picsum.photos/260/203",
    all: ["https://picsum.photos/260/201"],
  },
  price: 155,
  rating: 1.5,
  offerType: "Flat",
...
describe("Application Routing", () => {
  ...
  it('should render "FavoritesPage" when user navigates to "/favorites" while authorized', () => {
    history = createMemoryHistory();

    const createFakeStore = configureStore([thunk.withExtraArgument(api)]);
    store = createFakeStore({
      USER: { authorizationStatus: AuthorizationStatus.AUTH },
      DATA: { favoriteAds: [], favoriteAdsAreLoaded: true },
    });
