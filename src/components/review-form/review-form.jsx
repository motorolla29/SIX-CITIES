...
function ReviewForm({ adId }) {
  ...
  const getIsButtonDisabled = () =>
    !(formData.rating && formData.comment.length >= CommentFormLength.MIN) ||
    !commentIsPosted;

  return (
    <form
      className={`reviews__form form ${!commentIsPosted && DISABLED_CLASSNAME}`}
      action="#"
      method="post"
      onSubmit={onSubmit}
      ref={formNode}
    >
      ...
      <InputStarList
        onInput={(e) =>
          setFormData({ ...formData, rating: e.target.value || null })
        }
      />
      <textarea
        onInput={(e) =>
      ...
      <div className="reviews__button-wrapper">
        <p className="reviews__help">
          ...
          <b className="reviews__text-amount">
            {CommentFormLength.MIN} characters
          </b>
          .
        </p>
        <button
